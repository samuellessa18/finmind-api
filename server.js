...
const { z } = require('zod');
const { calculateSummary } = require('./src/engine/financialEngine');
const { startDailyAnalysisJob, runDailyAnalysis } = require('./src/jobs/dailyAnalysisJob');
const { startNotificationScheduler } = require('./src/engine/notificationScheduler');
const { trackEvent, getAnalyticsSummary, getEmotionalAnalyticsSummary, getPersonalTimeline } = require('./src/analytics/behaviorMetrics');
const { addXP } = require('./src/services/gamificationService');
